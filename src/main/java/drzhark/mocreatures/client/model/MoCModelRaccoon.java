...
public class MoCModelRaccoon extends EntityModel<MoCEntityRaccoon> {
    ...
    public MoCModelRaccoon() {
        ...
        this.RightSideburn.setPos(-2.5F, 0.5F, -3.2F);
        ...
        this.LeftSideburn.setPos(2.5F, 0.5F, -3.2F);
        ...
        this.RightFrontLegA.setPos(0F, 18F, -4F);
        ...
        this.RightFrontLegB.setPos(0F, 18F, -4F);
        ...
        this.LeftFrontLegB.setPos(0F, 18F, -4F);
        ...
        this.RightRearLegB.setPos(0F, 18F, 4F);
        ...
        this.LeftRearLegB.setPos(0F, 18F, 4F);
        ...
        this.LeftRearLegA.setPos(0F, 18F, 4F);
        ...
        this.LeftRearFoot.setPos(0F, 18F, 4F);

    }

    @Override
    public void setupAnim(MoCEntityRaccoon entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4) {
        ...
        this.RightFrontLegA.xRot = (30F / this.radianF) + RLegXRot;
        this.LeftFrontLegA.xRot = (30F / this.radianF) + LLegXRot;
        this.RightRearLegA.xRot = (53F / this.radianF) + LLegXRot;
        this.LeftRearLegA.xRot = (53F / this.radianF) + RLegXRot;

        this.RightFrontLegB.xRot = (-21F / this.radianF) + RLegXRot;
        this.RightFrontFoot.xRot = RLegXRot;
        this.LeftFrontLegB.xRot = (-21F / this.radianF) + LLegXRot;
        this.LeftFrontFoot.xRot = LLegXRot;

        this.RightRearLegB.xRot = (53F / this.radianF) + LLegXRot;
        this.RightRearFoot.xRot = LLegXRot;
        this.LeftRearLegB.xRot = (53F / this.radianF) + RLegXRot;
